  ...
  return (
    <AuthLayout>
      <Card className="bg-white/20 dark:bg-neutral-900/80">
        <CardHeader className="text-center text-2xl font-bold mb-2">Create your ReviveForge account</CardHeader>
        <form onSubmit={handleSubmit(onSubmit)}>
          <CardContent className="flex flex-col gap-4">
            ...
            <Button type="button" variant="outline" className="w-full" onClick={signupWithGitHub} disabled={loading}>
              Sign up with GitHub
            </Button>
          </CardContent>
        </form>
        <CardFooter className="flex flex-col items-center gap-2 mt-2">
          <span className="text-xs text-gray-400">Already have an account? <a href="/login" className="underline">Login</a></span>
        </CardFooter>
      </Card>
    </AuthLayout>
  );
